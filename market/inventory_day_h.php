        ...
        <div id="wraper" style="background-color: silver; height: 100px;" >
                    ...
                    <form name="searchform">
                        <center>
                            ...
                            <ul class="uris" dir="rtl" style="" >  
                                <li>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>  
                                <li> <a href="settings_h.php" class="h_a"
                                        style=" height: 122px; ">
                                ...
                                <li><a href="inventory_day_h.php" class="h_a" 
                                       style="height: 122px;  padding:9px 9px 9px 9px; text-shadow: 5px 2px 5px gray;
                                       color:white; background-color: #293f5a;"> <b>صفحة الجرد</b></a> </li> 
                                <li><a href="#" class="h_a" style="height: 122px;"> <b>استعلامات</b></a> </li> 
                                <li>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li> 
                                <li><input disabled="" type="text" maxlength="55" id="myInput" autocomplete="none" autofocus=""
                                           onkeyup="myFunction()" placeholder=""
                                           title="Type in a name" style="border: 0px; font-size: 1.2em; direction: rtl; 
            ...
            <div style="float:top; margin-bottom: 22px;  margin-top: 0px;">
                <div style="float: right; width: 23%; "> 
                    <a href="#"  class="list-group-item" id="head"><h4>صفحة الجرد </h4></a>
                    <a href="inventory_day_h.php" class="list-group-item" id="selected">الجرد اليومي<h4></h4></a>
                    <a href="inventory_month_h.php" class="list-group-item" id="m">الجرد الشهري </a>
                    <a href="monthly_sold_h.php" class="list-group-item" id="m">مبيعات الاشهر</a>
                    <a href="leak_page_h.php" class="list-group-item" id="m"> العجز</a>
                    <a href="increase_page_h.php" class="list-group-item" id="m">الزيادات</a>
                ...
                <div id="left" style=" border:3px solid #293f5a;">
                    <iframe src="inventory_day.php"  style="border-right-color: #293f5a; position: fixed; left: 0px; width: 77%; height: 82%; " name="cont"></iframe>
                </div>
