        ...
        <div id="wraper" style="background-color: silver; height: 100px;" >
                        ...
                        <center>
                            ...
                            <ul class="uris" dir="rtl" style="" >  
                                ...
                                <li><a href="selling.php" class="h_a" style="margin-left: 2px; height: 122px;">
                                        <b>صفحة البيع</b></a></li>
                                <li><a href="" class="h_a" style="height: 122px;"><b>عرض الفواتير</b></a></li>
            ...
            <div style="float:top; margin-bottom: 22px;  margin-top: 0px;">
                <div style="float: right; width: 23%; "> 
                    ...
                    <a href="add_new_products_h.php" class="list-group-item" id="m">إضافة وتعديل المنتجات<h4></h4></a>
                    <a href="add_new_employee_h.php" class="list-group-item" id="selected">إضافة وتعديل الموظفين</a>
                ...
                <div id="left" style=" border:3px solid #293f5a;">
                    <iframe src="add_employee.php"  style="border-right-color: #293f5a; position: fixed; left: 0px; width: 77%; height: 82%; " name="cont"></iframe>
                </div>
            </div>
        </div>
    </body>
