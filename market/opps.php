...
<body style="background-image: url('images/sky.jpg'); background-size: cover;" > 
                ...
                <form name="searchform">
                    <center>
                        ...
                        <ul class="uris" dir="rtl" style="" >  
                            <li>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>  
                            <li> <a href="settings_h.php" class="h_a" style="margin-left: 2px; height: 122px;">
    ...
    <div id="wraper" style=" height: 100px;" >
        ...
        <br /><br />
<center>
    <img src="images/opps.jpg" alt=""/>
    <h1> !عفوا ليس من صلاحيتك الدخول لهذه البيانات </h1>
    <h1>Sorry , You can't access this page !</h1>
</center>
        
<a style='color:whitesmoke;  border-radius:8px; font-size: 20px; position: fixed; 
   top: 1px; right:2px; border-radius:8px; font-weight: bold; text-decoration: none;' 
   href="#" onclick="window.history.back()">&nbsp; عودة للصفحة السابقة   &nbsp;</a> 
