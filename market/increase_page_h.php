...
<html>
    <head>
        ...
        <script>
            function load() {
                document.getElementById('left').autofocus = '';
            }
        </script>
    </head>
        ...
        <div id="wraper" style="background-color: silver; height: 100px;" >
                    ...
                    <form name="searchform">
                        <center>
                            ...
                            <ul class="uris" dir="rtl" style="" >  
                                ...
                                <li><a href="inventory_month_h.php" class="h_a"
            ...
            <div style="float:top; margin-bottom: 22px;  margin-top: 0px;">
                <div style="float: right; width: 23%; "> 
                    ...
                    <a href="inventory_day_h.php" class="list-group-item" id="m">الجرد اليومي<h4></h4></a>
                    ...
                    <a href="increase_page_h.php" class="list-group-item" id="selected">الزيادات</a>
                ...
                <div id="left" style=" border:3px solid #293f5a;">
                    <iframe src="increase_page.php" style="border-right-color: #293f5a; position: fixed;
                            left: 0px; width: 77%; height: 82%; " name="cont" id="content"></iframe>
                </div>
