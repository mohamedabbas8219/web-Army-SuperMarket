            ...
            <div style="float:top; margin-bottom: 22px;  margin-top: 0px;">
                <div style="float: right; width: 23%; "> 
                    ...
                    <div class="list-group-item" style="position:fixed; bottom: 12px; width: 23%; 
                         border: none; border-bottom-left-radius: 25% 100%; background-color: #293f5a;"></div>
                    <script src="js/jquery-3.2.1.min.js"></script>
                    <script src="js/bootstrap.min.js"></script>
                </div>  

                <div id="left" style=" border:3px solid #293f5a;">
                    <iframe src="settings.php"  style="border-right-color: #293f5a; position: fixed; left: 0px; width: 77%; height: 82%; " name="cont"></iframe>
                </div>
