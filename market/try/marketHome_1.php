                ...
                <div id="topnav" style="width:98%; background-color:whitesmoke; border-bottom-color:#293f5a;" >
                    <form name="searchform">
                        <center>
                            ...
                            <ul class="uris" >  
                                <li>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>  
                                <li > <a href="add_new_products_h.php" style="font-size: 1.2em;">
                                ...
                                <li><a href="inventory_hpage.php" style="font-size: 1.2em;"> <b>صفحة الجرد</b></a> </li>
                                <li><a href="" style="font-size: 1.2em;"> <b>استعلامات</b></a> </li> 
                                <!-- <li><a href="#" ><b style="font-size: 1.5em;">Search Here</b> </a></li> -->
                                <li>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li> 
                                
                                <li><input type="text" maxlength="55" id="myInput" autocomplete="none"
           ...
           <!-- ####### selected ################################################################### --> 
            ...
            <table style='direction:rtl; border:2px #0F4D21 solid;' id="ffatora">
                ...
                <center><nobr>
                        ...
                        <input type='submit' onclick="window.open('marketHome.php','_self')" class='btn' id='btn2' value='إلغاء' /><br />
                        <?php
                        if($done==1){
                            // echo "<b style='font-size:11px; color:green;'> done</b>";
                            }
                            elseif ($done==0) { 
                               // echo "<b style='font-size:11px; color:red;'>not done</b>";
                            }else {}  ?>
                    </nobr>
                </center>
                <?php //echo date("F j, Y, g:i a");
                  //$dd= get_date($conn);   ?>
                <input type="date" value="<?php echo $dd;  ?>" name="ddate" placeholder='غير التاريخ' style="width: 55%;
               text-align: center; height: 18px; font-size: 15px; background-color: silver;" />
            </td>
                </tr>
                <tr class='data'>
            ...
            <div class="scrollmenu" id="selected_products_div" style="  bottom: -1px;  position: fixed;
                ...
                <table name='selected_items' id="selected_products" dir="ltr" onchange="sum();"
                       class="selected_items_tbl" style="height: 90px;" >
                    <tr id="selected_prod_row" style="height: 90px;">
...
echo "
 ...
 ?>
         ...
         <div id="show_fatora_div" onclick="show_fatora()">
             <nobr> <b style="position: fixed; bottom: 6px; color:#293f5a; font-size: 15px; right: 1px;" >أنظر الفاتورة</b>
         <img src="images/seen.png" alt="see fatora" id="seen" style="
             position: fixed; bottom: 4px; right: 68px; width: 30px; height: 20px;"/></nobr>
            
         </div>
         <div id="hide_fatora_div" onclick="hide_fatora()">
             <nobr> <b style="position: fixed; bottom: 6px; color:#293f5a; font-size: 15px; right: 1px;" >إخفي الفاتورة</b>
                 <img src="images/unseen1.jpg" alt="see fatora" id="seen" style="
             position: fixed; bottom: 4px; right: 68px; width: 30px; height: 20px;"/></nobr>
         </div>
